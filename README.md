...
**things i've built:**
- [alloy](https://github.com/srijitiyer/alloy) - fast Rust CLI for LLM model merging. 10 merge algorithms, safetensors native
- [cortex](https://github.com/srijitiyer/cortex) - AI ad evaluation using Meta FAIR's TRIBE v2 with 3D brain visualization
